"""One-step tabular Q-learning updates for curriculum Stages 3 and 4."""
...
def setup_training(self):
    """Resume the exploration schedule unless explicitly reset."""
...
def update_q_table(
    ...
    if next_state is None:
        ...
        next_values = q_values(self.q_table, next_state, prior_q_tables)
