"""Linear Q-learning agent on the shared 24-dim feature vector."""
from collections import deque
from pathlib import Path

import numpy as np

from .shared.features import RECENT_POSITIONS_MAXLEN, build_feature_vector, track_position
...
def setup(self):
    if MODEL_FILE.is_file():
        self.q = LinearQ.load(MODEL_FILE)
...
def act(self, game_state):
    ...
    features = build_feature_vector(game_state, self.recent_positions)
